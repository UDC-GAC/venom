...
__all__ = [
    "OBS216pairPruningModifier",
    "OBS216pairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216pairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS216pairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216pairPruningParamsScorer(
            params=params,
...
class OBS216pairPruningParamsScorer(PruningParamsGradScorer):
    """
