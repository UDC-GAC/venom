...
__all__ = [
    "OBS28v128pairPruningModifier",
    "OBS28v128pairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28v128pairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28v128pairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28v128pairPruningParamsScorer(
            params=params,
...
class OBS28v128pairPruningParamsScorer(PruningParamsGradScorer):
    """
