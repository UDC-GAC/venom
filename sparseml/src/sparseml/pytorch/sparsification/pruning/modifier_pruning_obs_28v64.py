...
__all__ = [
    "OBSnm8v64PruningModifier",
    "OBSnm8v64PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBSnm8v64PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBSnm8v64PruningParamsScorer(
            params=params,
...
class OBSnm8v64PruningParamsScorer(PruningParamsGradScorer):
    """
