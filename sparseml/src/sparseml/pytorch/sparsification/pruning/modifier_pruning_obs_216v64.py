...
@PyTorchModifierYAML()
class OBSnm16v64PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBSnm16v64PruningParamsScorer(
            params=params,
...
class OBSnm16v64PruningParamsScorer(PruningParamsGradScorer):
    """
