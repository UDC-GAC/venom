...
__all__ = [
    "OBS_g_nm8v128PruningModifier",
    "OBS_g_nm8v128PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS_g_nm8v128PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS_g_nm8v128PruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS_g_nm8v128PruningParamsScorer(
            params=params,
...
class OBS_g_nm8v128PruningParamsScorer(PruningParamsGradScorer):
    """
