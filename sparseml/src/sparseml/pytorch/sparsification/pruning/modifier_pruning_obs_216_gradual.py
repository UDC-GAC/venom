...
__all__ = [
    "OBS216gPruningModifier",
    "OBS216gPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216gPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS216gPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216gPruningParamsScorer(
            params=params,
...
class OBS216gPruningParamsScorer(PruningParamsGradScorer):
    """
    ...
    def score_parameters(self) -> List[Tensor]:
        ...
        nm = {0.0:(7,16), 0.4375:(9,16), 0.5625:(11,16), 0.6875:(12,16), 0.75:(13,16), 0.8125:(14,16)}
