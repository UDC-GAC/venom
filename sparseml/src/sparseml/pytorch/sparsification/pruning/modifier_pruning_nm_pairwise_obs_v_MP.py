...
class OBSnmvpairPruningParamsScorer(PruningParamsGradScorer):
    ...
    def score_parameters(self) -> List[Tensor]:
        ...
        #nm = {0.0:(4,8), 0.5:(5,8)}
        #nm = {0.0:(2,4), 0.5:(3,4)}
        #nm = {0.0:(4,8), 0.5:(5,8), 0.625:(6,8)}
        #nm = {0.0:(13,16), 0.8125:(14,16)}
        ...
        #nm = {0.0: (23,32), 0.71875:(24,32), 0.75:(25,32), 0.78125:(26,32), 0.8125:(27,32) , 0.84375:(28,32), 0.875:(29,32), 0.90625:(30,32)}
        ...
        m=2; n=1
        v=128
        m_p = nn_row if ((mm_row-nn_row)>3) else (mm_row-4)
