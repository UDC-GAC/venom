...
__all__ = [
    "OBS28PruningModifier",
    "OBS28PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28PruningParamsScorer(
            params=params,
...
class OBS28PruningParamsScorer(PruningParamsGradScorer):
    """
