...
__all__ = [
    "OBSnm8v128PruningModifier",
    "OBSnm8v128PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBSnm8v128PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBSnm8v128PruningParamsScorer(
            params=params,
...
class OBSnm8v128PruningParamsScorer(PruningParamsGradScorer):
    """
