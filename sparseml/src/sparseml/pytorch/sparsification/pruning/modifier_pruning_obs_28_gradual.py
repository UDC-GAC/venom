...
__all__ = [
    "OBS28gPruningModifier",
    "OBS28gPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28gPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28gPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28gPruningParamsScorer(
            params=params,
...
class OBS28gPruningParamsScorer(PruningParamsGradScorer):
    """
