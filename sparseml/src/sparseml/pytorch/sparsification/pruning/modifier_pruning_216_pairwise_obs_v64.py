...
__all__ = [
    "OBS216v64pairPruningModifier",
    "OBS216v64pairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216v64pairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS216v64pairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216v64pairPruningParamsScorer(
            params=params,
...
class OBS216v64pairPruningParamsScorer(PruningParamsGradScorer):
    """
