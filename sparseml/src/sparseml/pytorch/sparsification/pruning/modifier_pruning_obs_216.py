...
__all__ = [
    "OBS216PruningModifier",
    "OBS216PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216PruningParamsScorer(
            params=params,
...
class OBS216PruningParamsScorer(PruningParamsGradScorer):
    """
