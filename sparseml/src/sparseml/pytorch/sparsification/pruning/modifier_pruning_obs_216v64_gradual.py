...
__all__ = [
    "OBS_g_nm16v64PruningModifier",
    "OBS_g_nm16v64PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS_g_nm16v64PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS_g_nm16v64PruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS_g_nm16v64PruningParamsScorer(
            params=params,
...
class OBS_g_nm16v64PruningParamsScorer(PruningParamsGradScorer):
    """
    ...
    def score_parameters(self) -> List[Tensor]:
        ...
        nm = {0.0:(11,16), 0.6875:(12,16), 0.75:(13,16), 0.8125:(14,16)}
