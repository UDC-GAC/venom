...
__all__ = [
    "OBS_g_nm8v64PruningModifier",
    "OBS_g_nm8v64PruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS_g_nm8v64PruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS_g_nm8v64PruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS_g_nm8v64PruningParamsScorer(
            params=params,
...
class OBS_g_nm8v64PruningParamsScorer(PruningParamsGradScorer):
    """
