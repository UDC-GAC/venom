...
__all__ = [
    "OBS28pairPruningModifier",
    "OBS28pairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28pairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28pairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28pairPruningParamsScorer(
            params=params,
...
class OBS28pairPruningParamsScorer(PruningParamsGradScorer):
    """
