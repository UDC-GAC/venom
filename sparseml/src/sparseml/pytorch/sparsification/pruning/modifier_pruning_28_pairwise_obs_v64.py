...
__all__ = [
    "OBS28v64pairPruningModifier",
    "OBS28v64pairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28v64pairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28v64pairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28v64pairPruningParamsScorer(
            params=params,
...
class OBS28v64pairPruningParamsScorer(PruningParamsGradScorer):
    """
